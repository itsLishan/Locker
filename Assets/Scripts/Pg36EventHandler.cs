...
public class Pg36EventHandler : MonoBehaviour, IVirtualButtonEventHandler {
	...
	public void OnButtonPressed(VirtualButtonAbstractBehaviour vb){
		...
		Handheld.PlayFullScreenMovie ("Pg36Movie.mp4", Color.black, FullScreenMovieControlMode.Hidden);
	}
