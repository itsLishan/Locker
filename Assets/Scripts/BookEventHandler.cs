...
public class BookEventHandler : MonoBehaviour, IVirtualButtonEventHandler {
	...
	public void OnButtonPressed(VirtualButtonAbstractBehaviour vb){
		...
		Handheld.PlayFullScreenMovie ("BookMovie.mp4", Color.black, FullScreenMovieControlMode.Hidden);
	}
