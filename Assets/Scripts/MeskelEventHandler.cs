...
public class MeskelEventHandler : MonoBehaviour, IVirtualButtonEventHandler {
	...
	public void OnButtonPressed(VirtualButtonAbstractBehaviour vb){
		...
		Handheld.PlayFullScreenMovie ("MeskelMovie.mp4", Color.black, FullScreenMovieControlMode.Hidden);
	}
